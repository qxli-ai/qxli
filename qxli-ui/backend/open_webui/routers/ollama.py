        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                ...
                headers={
                    ...
                    **(
                        {
                            "X-QXLI-User-Name": user.name,
                            "X-QXLI-User-Id": user.id,
                            "X-QXLI-User-Email": user.email,
                            "X-QXLI-User-Role": user.role,
                        }
...
async def send_post_request(
    ...
    try:
        ...
        if r.ok is False:
            try:
                ...
                raise HTTPException(
                    ...
                    detail=f"QXLI: Server Connection Error",
                )
        ...
        raise HTTPException(
            ...
            detail=detail if e else "QXLI: Server Connection Error",
        )
    ...
    if url_idx is None:
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=detail if detail else "QXLI: Server Connection Error",
            )
