						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use QXLI and seek support from the community.')}
								</div>
							</div>
							...
							<div class="flex space-x-1">
								...
								<a href="https://twitter.com/QXLI" target="_blank">
									<img
										...
										src="https://img.shields.io/twitter/follow/QXLI"
									/>
								</a>
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								{#if $config?.license_metadata}
									<a
										href="https://demo.qxli.com/enterprise"
										target="_blank"
						...
						{#if adminConfig?.ENABLE_API_KEY_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<!-- https://demo.qxli.com/getting-started/advanced-topics/api-endpoints -->
									<a
										href="https://demo.qxli.com/getting-started/api-endpoints"
										target="_blank"
